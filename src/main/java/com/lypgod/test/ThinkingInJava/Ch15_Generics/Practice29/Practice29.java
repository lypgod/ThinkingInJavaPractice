package com.lypgod.test.ThinkingInJava.Ch15_Generics.Practice29;
...
public class Practice29 {
    ...
    static void f2(List<Holder<?>> list) {
        ...
        for (Holder<?> aList : list) {
            if (aList == null) System.out.println("null");
            else
