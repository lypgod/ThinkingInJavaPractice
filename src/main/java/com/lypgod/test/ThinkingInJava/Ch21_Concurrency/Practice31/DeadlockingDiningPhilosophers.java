package com.lypgod.test.ThinkingInJava.Ch21_Concurrency.Practice31;
...
class Philosopher implements Runnable {
    ...
    Philosopher(Chopstick left, Chopstick right, LinkedBlockingQueue<Chopstick> bin, int ident, int ponder) {
        this.left = left;
        this.right = right;
        this.bin = bin;
        id = ident;
