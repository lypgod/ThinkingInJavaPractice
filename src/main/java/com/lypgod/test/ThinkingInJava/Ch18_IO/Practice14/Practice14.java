package com.lypgod.test.ThinkingInJava.Ch18_IO.Practice14;
...
public class Practice14 {
    ...
    public static void main(String[] args) throws IOException {
        BufferedReader in = new BufferedReader(new StringReader(BufferedInputFile.read("BasicFileOutput14.java")));
        // Buffered writer:
        ...
        BufferedReader in2 = new BufferedReader(new StringReader(BufferedInputFile.read("BasicFileOutput14.java")));
        // Unbuffered writer:
